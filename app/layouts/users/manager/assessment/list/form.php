...
<html><head>
    <title>List of assessments | <?=APP_BRAND;?></title>
...
<div class="container">
    <div class="row">
        <div class="col-md-9">
            ...
            <?=$table->render()?>
            <script>document.getElementById("checkAll").addEventListener('change',function(e){var checked=this.checked; [].forEach.call(document.querySelectorAll('.checkItem'), function(x) { x.checked=checked;});}, false);</script>
        </div>
        <div class="col-md-3">
