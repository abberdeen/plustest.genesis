...
class  NumericView extends FormView{
        ...
        switch(parent::getViewStyle()){
            case FormViewStyle::NUMERIC_CLASSIC:
                return '<div class="form-group">'.
                            ...
                            '<input type="text" autocomplete="off" class="form-control form-control-sm numbox" value="'.parent::getValue().'" name="'.parent::getName().'" id="'.parent::getId().'" style="width:200px;">'.
                        '</div>';
                break;
        }
    }
