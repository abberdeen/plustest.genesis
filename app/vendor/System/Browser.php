...
class Browser {
    ...
    const BROWSER_OPR = 'Opera CB';                           // Opera Chromium based
    ...
    */
    ...
    /**
     * Determine if the browser is Opera Chromium based or not
     * @return boolean True if the browser is Opera Chromium based otherwise false
     */
